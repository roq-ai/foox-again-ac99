  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox again - A vibrant marketplace bridging the gap between skilled freelancers and companies seeking top-tier talent for their jobs."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox again - A vibrant marketplace bridging the gap between skilled freelancers and companies seeking top-tier talent for their jobs.`}
            </Text>
            <Box
